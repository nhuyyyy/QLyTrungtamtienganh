 ...
 * @author ADMIN
 */
public class thisinhSuggest extends javax.swing.JDialog {
  DefaultTableModel table;
    /**
     * Creates new form thisinhSuggest
     */
    public thisinhSuggest() {
       initComponents();
        setModal(true);
        doDuLieuLenBang();
...
public void doDuLieuSearch(Map<String,String> map)
    ...
    public void cleanView() //Xóa trắng các TextField
    {
     ...
     {
         System.out.println(this.txtMaThiSinh.getText());
        return  this.txtMaThiSinh.getText();
   }
}
